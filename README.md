...
- I would complete the implementation of Level 4, as described in comments.  I would consider breaking some of the newer features/elements into seperate components.
